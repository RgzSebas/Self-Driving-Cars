...
# ==================================
radius = 8
distance = 2*(2*radius*np.pi) # 100.53 m
vel = distance / time_end # 3.35 m/s
delta = np.arctan(model.L/radius) # 14.036 deg, 0.244 rad
size = t_data.shape[0] # 30 seg * 1/0.01 samples per second = 3000 samples
